              ...
              >
                ...
                <template v-if="dataRow.add == 1">
                  ...
                  <badaso-number
                    ...
                    :label="dataRow.displayName == 'Lbs'? 'Kg':dataRow.displayName"
                    :placeholder="dataRow.displayName == 'Lbs'? 'Kg':dataRow.displayName"
                    v-model="dataRow.value"
                    size="12"
                    :alert="
                      errors[$caseConvert.stringSnakeToCamel(dataRow.field)]
...
export default {
  ...
  methods: {
    convert() {
      ...
      this.dataType.dataRows[5].value = this.kg * 2
    },
    ...
    submitForm() {
      ...
      for (const row of this.dataType.dataRows) {
        if (row && row.value) {
          ...
          if(row.field == "lbs"){
            dataRows[row.field] = row.value * 2.20462
          }else{
