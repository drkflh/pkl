...
class coldexport implements FromCollection, WithMapping, WithHeadings, ShouldAutoSize, WithDrawings, WithStyles, withEvents, WithColumnWidths
...

{
    ...
    public function map($cold_storage): array

    {

        return [
            $cold_storage->nama_cold_storage,
